...
const TermsOfService = ({ visible, toggleVisibility }) => {
  return (
    <div>
      ...
      {visible && (
        ...
        >
          ...
          <p>
            ⑤ "몰" 내에서 구매한 상품을 타 사이트에서 재 판매하는 회원의 경우,
            별도의 고지 없이 탈퇴 처리되며, 법적인 조치가 진행될 수 있습니다.
          </p>
          ...
          <p>
            ...
            개인정보 보호책임자의 신원(소속, 성명 및 전화번호, 기타 연락처),
